...
public class MyScoreFragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(MyScoreFragment.class.getSimpleName()).commitAllowingStateLoss();
