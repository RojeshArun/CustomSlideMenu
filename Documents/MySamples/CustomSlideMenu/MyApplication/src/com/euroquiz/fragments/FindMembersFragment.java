...
public class FindMembersFragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(FindMembersFragment.class.getSimpleName()).commitAllowingStateLoss();
