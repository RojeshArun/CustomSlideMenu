...
public class CoinForReferralFragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(CoinForReferralFragment.class.getSimpleName()).commitAllowingStateLoss();
