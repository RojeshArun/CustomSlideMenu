...
public class AccountSettingsFragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(AccountSettingsFragment.class.getSimpleName()).commitAllowingStateLoss();
