...
public class BuyPremiumFragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(BuyPremiumFragment.class.getSimpleName()).commitAllowingStateLoss();
