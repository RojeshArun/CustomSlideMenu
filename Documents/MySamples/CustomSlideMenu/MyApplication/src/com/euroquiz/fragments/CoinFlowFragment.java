...
public class CoinFlowFragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(CoinFlowFragment.class.getSimpleName()).commitAllowingStateLoss();
