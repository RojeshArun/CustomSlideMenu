...
public class Top100Fragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(Top100Fragment.class.getSimpleName()).commitAllowingStateLoss();
