...
public class MySubscriptionFragment extends Fragment implements OnClickListener {
	...
	private void gotoYesterDayFragment() {
		...
		mFragmentTransaction.replace(R.id.frame_layout, mYesterdaysResultFragment).addToBackStack(MySubscriptionFragment.class.getSimpleName()).commitAllowingStateLoss();
